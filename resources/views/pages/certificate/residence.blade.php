...
<div class="page-header">
	<h1 class="page-title my-auto">Residence Certificate</h1>
	<div>
		<ol class="breadcrumb mb-0">
			<li class="breadcrumb-item">
				<a href="javascript:void(0)">Forms</a>
			</li>
			<li class="breadcrumb-item active" aria-current="page">Residence Certificate</li>
		</ol>
	</div>
</div>
...
<div class="row">
	<div class="col-md-8">
		<div class="card">
			...
			<div class="card-body">
				<form action="{{ route("certificate.store.residence") }}" method="POST">
					@csrf
					<div class="row g-3">
						...
						<div class="col-md-6">
							...
							<input value="{{ old("living_since") }}" type="text" name="living_since" class="form-control flatpickr-human-friendly @error('living_since') is-invalid @enderror" placeholder="Choose a date" required />
							@error("living_since")
