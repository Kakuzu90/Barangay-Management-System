<ul class="main-menu">
	...
	<li class="slide has-sub">
		...
		<ul class="slide-menu child1">
			...
			<li class="slide">
				<a href="#" class="side-menu__item">Active Purok Leaders</a>
			</li>
			<li class="slide">
				<a href="#" class="side-menu__item">Manage Purok Leaders</a>
			</li>
		</ul>
	</li>
	...
	<li class="slide has-sub">
		...
		<ul class="slide-menu child1">
			...
			<li class="slide">
				<a href="#" class="side-menu__item">Active Officials</a>
			</li>
			<li class="slide">
				<a href="#" class="side-menu__item">Manage Officials</a>
			</li>
		</ul>
	</li>
	...
	<li class="slide has-sub">
		...
		<ul class="slide-menu child1">
			...
			<li class="slide">
				<a href="#" class="side-menu__item">Clearance</a>
			</li>
			<li class="slide">
				<a href="#" class="side-menu__item">Birth Certificate</a>
			</li>
			<li class="slide">
				<a href="#" class="side-menu__item">Large Cattle</a>
			</li>
			<li class="slide">
				<a href="#" class="side-menu__item">Residence Certificate</a>
			</li>
			<li class="slide">
				<a href="#" class="side-menu__item">Residence Sports Certificate</a>
			</li>
		</ul>
	</li>
